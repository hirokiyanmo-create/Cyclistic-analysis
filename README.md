...
<img width="990" height="595" alt="image" src="https://github.com/user-attachments/assets/6d3260c6-c1fc-4c27-926d-d5dc9b6ac14d" />
  ...
  - 月間推移
    ...
    - Casual : 7月にピーク（1月の約12倍） : 観光シーズンでの利用増加 
...
## 提言
  1.  Casualメンバーに対し、土日 / 平日の午後 に年間利用を促すポップアップ / 広告を表示
  
  2. 夏季に向け、Casual会員がよく利用する駅に広告を設置（Navy Pierを中心にする）

  3. 1回利用券 / 1日利用券の値段を上げる（年間料金は維持）
    - 値段の改定により年間会員への推移を計測する

  4. 使用回数 / 利用料金 / 年間料金に切り替えた際のお得な金額を確認できるシミュレーターの作成
